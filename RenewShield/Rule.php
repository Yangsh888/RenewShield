...
class Rule
{
    ...
    public static function waf(): array
    {
        return [
            ...
            [
                'key' => 'xss.style.legacy',
                'group' => 'xss',
                'score' => 80,
                'message' => '检测到旧式 CSS 注入特征',
                'pattern' => '/style\s*=\s*["\'][\s\S]*?(?:expression\s*\(|-moz-binding\s*:)/i',
                'targets' => ['query', 'body'],
            ],
            [
                'key' => 'cmd.exec',
            ...
            [
                ...
                'group' => 'protocol',
                'score' => 70,
                'message' => '检测到本地 Host 伪造特征',
                'pattern' => '/(?:^|\n)host:\s*(?:0\.0\.0\.0|127\.0\.0\.1|localhost(?:\.localdomain)?)(?:\n|$)/i',
                'targets' => ['headers'],
            ],
            [
                'key' => 'cve.known',
