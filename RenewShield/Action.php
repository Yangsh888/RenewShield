...
class Action extends \Typecho\Widget
{
    ...
    private function requirePost(string $message = '该操作必须通过 POST 提交'): void
    {
    ...
    private function save(): void
    {
        ...
        $basicPass = trim((string) ($_POST['basicAuthPass'] ?? ''));
        if ($basicPass !== '') {
            $next['basicAuthHash'] = password_hash($basicPass, PASSWORD_BCRYPT, ['cost' => 12]);
        }
