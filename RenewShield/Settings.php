...
class Settings
{
    ...
    public static function normalize(array $settings): array
    {
        ...
        $settings['scriptClientPolicy'] = self::choice((string) ($settings['scriptClientPolicy'] ?? 'observe'), ['observe', 'challenge', 'block'], 'observe');
